...
var compile = require('./mk-compiler');
var execute = require('./mk-executor');
var addInstructionsToBrowserify = require('./mk-bundler');
...
exports = module.exports = function bootLoopBackApp(app,
  options, actions, callback) {
